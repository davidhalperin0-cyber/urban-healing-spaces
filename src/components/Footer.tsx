    ...
    <footer className="relative bg-gradient-to-b from-background to-healing-warmth py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            Connect with us and be part of creating healing spaces across the city
          </motion.p>
          ...
          >
            <p>© 2024 Urban Healing Spaces Network. All rights reserved.</p>
          </motion.div>
        </div>
      </div>
      ...
      {showBackToTop && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 p-4 bg-primary text-primary-foreground rounded-full shadow-[0_10px_30px_-10px_hsl(var(--healing-terracotta)/0.5)] hover:shadow-[0_15px_40px_-10px_hsl(var(--healing-terracotta)/0.6)] hover:scale-110 transition-all duration-300 z-50 animate-glow"
